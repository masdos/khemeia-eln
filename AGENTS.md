...
<!-- Local customization: not from pydevtools.com -->
...
3.  **NEVER** commit sensitive data, secrets, or `.env` files. Reference secrets by their location in the environment or vault, never by value.
